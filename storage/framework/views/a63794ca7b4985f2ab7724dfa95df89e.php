   ...
   <main class="content">
       ...
       <div class="row">
           <div class="col-12">
               <div class="card">
                   <div class="card-body">
                       <a class="btn btn-primary mb-3"  href="<?php echo e(route('users.create')); ?>">
                           ...
                           <?php $__currentLoopData = $users; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                               <tr>
                                   ...
                                   <td>
                                       ...
                                       <a href="<?php echo e(route('users.show',$user->id)); ?>" class="btn btn-success">
                                       ...
                                       <form class="d-inline" action="<?php echo e(route('users.destroy',$user->id)); ?>" method="post "onsubmit="return confirm('<?php echo e(trans('Ochirish')); ?>');">
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/webteam5/admin/resources/views/admin/users/index.blade.php ENDPATH**/ ?>
        ...
        <nav id="sidebar" class="sidebar js-sidebar">
            <div class="sidebar-content js-simplebar">
                <a class="sidebar-brand" href="<?php echo e(route('admin')); ?>">
                    <span class="align-middle">Penablok market</span>
                </a>
                ...
                <ul class="sidebar-nav">
                    ...
                    <li class="sidebar-item <?php echo e((request()->is('permissions*')) ? 'active' : ''); ?>">
                        <a class="sidebar-link" href="<?php echo e(route('permissions.index')); ?>">
                    ...
                    <li class="sidebar-item <?php echo e((request()->is('categories*')) ? 'active' : ''); ?>">
                        <a class="sidebar-link active" href="<?php echo e(route('categories.index')); ?>">
                            <i class="align-middle" data-feather="book"></i> <span class="align-middle">Categories</span>
                        </a>
                    </li>
                    <li class="sidebar-item <?php echo e((request()->is('media*')) ? 'active' : ''); ?>">
                        <a class="sidebar-link active" href="<?php echo e(route('media.index')); ?>">
...
<?php /**PATH /var/www/html/webteam5/admin/resources/views/layouts/admin.blade.php ENDPATH**/ ?>